  ...
  const loadRecipe = async () => {
    try {
      ...
      setFormData({
        ...
        categoryId: recipe.category?.id || recipe.categoryId || '',
        ...
        instructions: recipe.instructions && recipe.instructions.length > 0
          ...
          : [{ step: 1, description: '', image: '', duration: '' }],
        tags: recipe.tags || [],
        thumbnail: recipe.thumbnail || recipe.images?.[0] || '',
      })
    } catch (error) {
      ...
      const payload = {
        ...
        instructions: formData.instructions
          ...
          .map((inst, idx) => ({
            ...inst,
            step: idx + 1,
            duration: inst.duration ? parseInt(inst.duration) : 0,
          })),
      }
